...
def init(dotenv_path, set_default):
    ...
    if set_default:
        ...
        if not os.path.isdir(mamba_path):
            ...
            git.Git(mamba_path).clone('https://github.com/Akachain/akc-mamba.git', branch='v2.0-support-mongodb-binary-config')
    ...
    PEER_IMAGE = os.getenv('PEER_IMAGE')
    ...
    global STATEDB
    global STATEDB_PORT
    global STATEDB_PORT2
    global STATEDB_IMAGE
    global STATEDB_INIT_USER_NAME
    global STATEDB_INIT_PASSWORD_NAME
    global STATEDB_INIT_SECRET_NAME
    global CORE_LEDGER_STATE_CONFIG_ADDRESS
    global CORE_LEDGER_STATE_CONFIG_USERNAME
    global CORE_LEDGER_STATE_CONFIG_PASSWORD

    STATEDB = os.getenv('STATEDB')
    STATEDB_PORT = os.getenv('STATEDB_PORT')
    STATEDB_PORT2 = os.getenv('STATEDB_PORT2')
    STATEDB_IMAGE = os.getenv('STATEDB_IMAGE')
    STATEDB_INIT_USER_NAME = os.getenv('STATEDB_INIT_USER_NAME')
    STATEDB_INIT_PASSWORD_NAME = os.getenv('STATEDB_INIT_PASSWORD_NAME')
    STATEDB_INIT_SECRET_NAME = os.getenv('STATEDB_INIT_SECRET_NAME')
    CORE_LEDGER_STATE_CONFIG_ADDRESS = os.getenv('CORE_LEDGER_STATE_CONFIG_ADDRESS')
    CORE_LEDGER_STATE_CONFIG_USERNAME = os.getenv('CORE_LEDGER_STATE_CONFIG_USERNAME')
