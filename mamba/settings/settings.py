...
def init():
    ...
    global ENABLE_LDAP, ROOT_CA_LDAP_URL, INTERMEDIATE_CA_LDAP_URL, ICA_PASS
    ENABLE_LDAP = os.getenv('ENABLE_LDAP')
    ROOT_CA_LDAP_URL = os.getenv('ROOT_CA_LDAP_URL')
    INTERMEDIATE_CA_LDAP_URL = os.getenv('INTERMEDIATE_CA_LDAP_URL')
    ICA_PASS = os.getenv('LDAP_ICA_PASS')
